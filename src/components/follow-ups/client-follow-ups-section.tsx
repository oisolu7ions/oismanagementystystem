  ...
  return (
    <Card>
      <CardHeader
        ...
        action={
          <Link href={`/dashboard/follow-ups/new?clientId=${clientId}`}>
            <Button size="sm">
        ...
        {followUps.length === 0 ? (
          <div className="rounded-lg border border-dashed border-slate-200 bg-slate-50 px-4 py-8 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Track payment reminders, check-ins, renewals, and content requests.
            </p>
            <Link
              href={`/dashboard/follow-ups/new?clientId=${clientId}`}
